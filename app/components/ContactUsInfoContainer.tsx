 ...
 */
export default function ContactUsInfoContainer({
    children,
}: {
    ...
    const height = useTransform(
        scrollY,
        CONTACT_INFO.SCROLL_RANGE,
        CONTACT_INFO.HEIGHT_RANGE
    );

    return (
        <motion.div
            className="max-md:w/full relative h-[760px] w-full max-md:h-[450px] lg:w-[70%]"
            style={{ height }}
        >
            {children}
        </motion.div>
