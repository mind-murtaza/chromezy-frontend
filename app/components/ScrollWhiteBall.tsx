...
import { SCROLL_WHITE_BALL } from '@/app/lib/constants';
...
export default function ScrollWhiteBall() {
    ...
    const top = useTransform(
        scrollY,
        SCROLL_WHITE_BALL.RANGES,
        SCROLL_WHITE_BALL.TOP_VALUES
    );
    const left = useTransform(
        scrollY,
        SCROLL_WHITE_BALL.RANGES,
        SCROLL_WHITE_BALL.LEFT_VALUES
    );
    const size = useTransform(
        scrollY,
        SCROLL_WHITE_BALL.RANGES,
        SCROLL_WHITE_BALL.SIZE_VALUES
    );
    const rotate = useTransform(
        scrollY,
        SCROLL_WHITE_BALL.RANGES,
        SCROLL_WHITE_BALL.ROTATE_VALUES
    );
