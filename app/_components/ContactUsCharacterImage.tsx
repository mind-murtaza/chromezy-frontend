...
import { CONTACT_CHARACTER } from '@/app/_lib/constants';
...
export default function ContactUsCharacterImage() {
    ...
    const heightCharacter = useTransform(scrollY, CONTACT_CHARACTER.SCROLL_RANGE, CONTACT_CHARACTER.SIZE_RANGE);
    const widthCharacter = useTransform(scrollY, CONTACT_CHARACTER.SCROLL_RANGE, CONTACT_CHARACTER.SIZE_RANGE);
    const opacityCharacter = useTransform(scrollY, CONTACT_CHARACTER.SCROLL_RANGE, CONTACT_CHARACTER.OPACITY_RANGE);
    const topCharacter = useTransform(scrollY, CONTACT_CHARACTER.SCROLL_RANGE, CONTACT_CHARACTER.TOP_RANGE);
